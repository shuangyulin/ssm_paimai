...
<%
    ...
    String paypalAccount = (String)request.getAttribute("paypalAccount"); //paypal账户名查询关键字
			...
			<div class="col-md-3 bottom15" <%=clearLeft %>>
			  <a  href="<%=basePath  %>UserInfo/<%=userInfo.getUser_name() %>/frontshow"><img class="img-responsive" src="<%=basePath%><%=userInfo.getUserImage()%>" /></a>
			     <div class="showFields">
			     	...
			     	<div class="field">
	            		所在城市:<%=userInfo.getCity() %>
			     	</div>
			     	<div class="field">
	            		paypal账户名:<%=userInfo.getPaypalAccount() %>
			     	</div>
			     	<div class="field">
	            		注册时间:<%=userInfo.getCreateTime() %>
			     	</div>
	...
	<div class="col-md-3 wow fadeInRight">
		...
		<form name="userInfoQueryForm" id="userInfoQueryForm" action="<%=basePath %>UserInfo/frontlist" class="mar_t15" method="post">
			<div class="form-group">
				<label for="paypalAccount">paypal账户名:</label>
				<input type="text" id="paypalAccount" name="paypalAccount" value="<%=paypalAccount %>" class="form-control" placeholder="请输入paypal账户名">
			</div>
			<div class="form-group">
