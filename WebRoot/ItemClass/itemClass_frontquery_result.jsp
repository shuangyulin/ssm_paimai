...
<jsp:include page="../header.jsp"></jsp:include>
		...
		<div class="col-md-12 wow fadeInDown" data-wow-duration="0.5s">
			<div>
				...
				<ul class="nav nav-tabs" role="tablist">
			    	...
			    	<li role="presentation" class="active"><a href="#itemClassListPanel" aria-controls="itemClassListPanel" role="tab" data-toggle="tab">商品类别列表</a></li>
			    	<li role="presentation" ><a href="<%=basePath %>ItemClass/itemClass_frontAdd.jsp" style="display:none;">添加商品类别</a></li>
				</ul>
			  	<!-- Tab panes -->
				    		...
				    		<div class="row">
				    			<div class="col-md-12 top5">
				    				...
				    				<table class="table table-condensed table-hover">
				    					<tr class="success bold"><td>序号</td><td>商品分类id</td><td>商品类别名称</td><td>操作</td></tr>
				    					<% 
				    						/*计算起始序号*/
				    	            		...
				    	            		for(int i=0;i<itemClassList.size();i++) {
					    	            		...
					    	            		ItemClass itemClass = itemClassList.get(i); //获取到商品类别对象
 										%>
 										<tr>
 											<td><%=currentIndex %></td>
	...
	<div style="display:none;">
		...
		<form name="itemClassQueryForm" id="itemClassQueryForm" action="<%=basePath %>ItemClass/frontlist" class="mar_t15" method="post">
