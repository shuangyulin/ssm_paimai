...
<%
    ...
    String pTitle = (String)request.getAttribute("pTitle"); //帖子标题查询关键字
				    		...
				    		<div class="row">
				    			<div class="col-md-12 top5">
				    				...
				    				<table class="table table-condensed table-hover">
				    					<tr class="success bold"><td>序号</td><td>帖子id</td><td>帖子标题</td><td>发帖人</td><td>发帖时间</td><td>浏览量</td><td>操作</td></tr>
				    					<% 
				    						/*计算起始序号*/
	...
	<div class="col-md-3 wow fadeInRight">
		...
		<form name="postInfoQueryForm" id="postInfoQueryForm" action="<%=basePath %>PostInfo/frontlist" class="mar_t15" method="post">
			<div class="form-group">
				<label for="pTitle">帖子标题:</label>
				<input type="text" id="pTitle" name="pTitle" value="<%=pTitle %>" class="form-control" placeholder="请输入帖子标题">
			</div>
