	...
	<div class="col-md-12 wow fadeInLeft">
		...
		<div class="row">
			<div class="col-md-10">
				  ...
				  <div class="form-group">
				  	 <label for="userInfo_birthDateDiv" class="col-md-2 text-right">生日:</label>
				  	 <div class="col-md-8">
		                <div id="userInfo_birthDateDiv" class="input-group date userInfo_birthDate col-md-12" data-link-field="userInfo_birthDate" data-link-format="yyyy-mm-dd">
		                    <input class="form-control" id="userInfo_birthDate" name="userInfo.birthDate" size="16" type="text" value="" placeholder="请选择生日" readonly>
				  ...
				  <div class="form-group">
				  	 <label for="userInfo_userImage" class="col-md-2 text-right">用户照片:</label>
				  	 <div class="col-md-8">
				  ...
				  <div class="form-group">
				  	 <label for="userInfo_city" class="col-md-2 text-right">所在城市:</label>
				  	 <div class="col-md-8">
					    <input type="text" id="userInfo_city" name="userInfo.city" class="form-control" placeholder="请输入所在城市">
					 </div>
				  </div>
				  <div class="form-group">
				  ...
				  <div class="form-group">
				  	 <label for="userInfo_paypalAccount" class="col-md-2 text-right">paypal账户名:</label>
				  	 <div class="col-md-8">
					    <input type="text" id="userInfo_paypalAccount" name="userInfo.paypalAccount" class="form-control" placeholder="请输入paypal账户名">
					 </div>
				  </div>
				  <div class="form-group">
				  	 <label for="userInfo_createTimeDiv" class="col-md-2 text-right">注册时间:</label>
				  	 <div class="col-md-8">
		                <div id="userInfo_createTimeDiv" class="input-group date userInfo_createTime col-md-12" data-link-field="userInfo_createTime">
		                    <input class="form-control" id="userInfo_createTime" name="userInfo.createTime" size="16" type="text" value="" placeholder="请选择注册时间" readonly>
		                    <span class="input-group-addon"><span class="glyphicon glyphicon-remove"></span></span>
		                    <span class="input-group-addon"><span class="glyphicon glyphicon-calendar"></span></span>
		                </div>
				  	 </div>
...
$(function(){
	...
	//注册时间组件
	$('#userInfo_createTimeDiv').datetimepicker({
		language:  'zh-CN',  //显示语言
		...
		$('#userInfoAddForm').data('bootstrapValidator').updateStatus('userInfo.createTime', 'NOT_VALIDATED',null).validateField('userInfo.createTime');
	});
	//生日组件
