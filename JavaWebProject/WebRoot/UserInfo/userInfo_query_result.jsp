...
<div id="userInfo_manage_tool" style="padding:5px;">
	...
	<div style="padding:0 0 0 7px;color:#333;">
		<form id="userInfoQueryForm" method="post">
			paypal账户名：<input type="text" class="textbox" id="paypalAccount" name="paypalAccount" style="width:110px" />
			...
			生日：<input type="text" id="birthDate" name="birthDate" class="easyui-datebox" editable="false" style="width:100px">
			联系电话：<input type="text" class="textbox" id="telephone" name="telephone" style="width:110px" />
			所在城市：<input type="text" class="textbox" id="city" name="city" style="width:110px" />
